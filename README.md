...
| # | 文档 | 核心内容 |
|---|------|---------|
| 1 | [需求规格说明书](docs/01-requirements.md) | 项目背景、系统架构、**11 大功能模块**详细设计 |
| 2 | [数据库设计](docs/02-database-design.md) | ER 关系图、**42 张表** DDL、迁移策略 |
| 3 | [界面原型设计](docs/03-ui-prototype.md) | 整体布局、**12 个核心页面** wireframe、交互规范 |
